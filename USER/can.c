...
int can_init(void *msg_rcv_callback_func){
    ...
    //配置过滤器
    can_filter_init_struct.CAN_FilterNumber = 0;    //过滤器0
    can_filter_init_struct.CAN_FilterMode   = CAN_FilterMode_IdMask;  //标识符过滤
    can_filter_init_struct.CAN_FilterScale  = CAN_FilterScale_32bit;   //16位模式
    can_filter_init_struct.CAN_FilterIdHigh = (u16)(CAN_FILTER_ID >> 4);   //32位ID 
    can_filter_init_struct.CAN_FilterIdLow  = (u16)(CAN_FILTER_ID);   
    can_filter_init_struct.CAN_FilterMaskIdHigh = (u16)(CAN_FILTER_MASK >> 4);  //32位MASK
    can_filter_init_struct.CAN_FilterMaskIdLow = (u16)(CAN_FILTER_MASK);  
    can_filter_init_struct.CAN_FilterFIFOAssignment = CAN_Filter_FIFO0;  //使用FIFO0
    can_filter_init_struct.CAN_FilterActivation = ENABLE;   //激活过滤器0
