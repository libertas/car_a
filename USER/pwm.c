...
/*
	0 fan 涵道风扇
	1 fan_updown 无刷
	2 fan_roll 舵机 0.5 - 0.21, 100Hz
	3 mag_in/out 舵机	0.06 - 0.10
	4 mag_near/far 舵机  0.05(end) - 0.087(start)
...
{
	float duties[PWM_CHANNEL_NUM] = {0.05, 0.071, 0.21, 0.10, 0.087};
	unsigned long freqs[PWM_CHANNEL_NUM] = {50, 50, 100, 50, 50};
